...
require (
	...
	// Note: Fabric SDK dependencies are not included to avoid compatibility issues
	// The service works in development mode (in-memory storage) without Fabric
	// To use actual Fabric network, install:
